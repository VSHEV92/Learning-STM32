...
void Peripheral_Init() {
    ...
    GPIO_InitTypeDef GPIO_InitStruct = {
        ...
        .Mode  = GPIO_MODE_AF_PP,        // alternstive function push-pull mode
        .Pull  = GPIO_NOPULL,            // disable pull up/down registers
        .Speed = GPIO_SPEED_FREQ_LOW,    // set slew rate to low
        .Alternate = GPIO_AF2_TIM2,      // connect GPIO pin to Timer 2
    };
    ...
    htim2.Init.Prescaler         = 800 - 1;                         // set timer clock prescaler
    ...
    HAL_TIM_OC_ConfigChannel(&htim2, &OC_Config, TIM_CHANNEL_2);
